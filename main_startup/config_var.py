...
class Config((object)):
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC", "https://telegra.ph/file/696a9f39f4245ae5a4fa6.jpg"
    )
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/SmartGirl15/FridayUserbot"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph/file/7ad344da468944db1fdff.jpg"
    )
    U_BRANCH = "master"
